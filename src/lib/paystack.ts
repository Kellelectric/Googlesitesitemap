// Server-side verification of a Paystack transaction. Used by
// app/api/book/route.ts to confirm a payment actually succeeded (and for
// the right amount/currency) before
