...
const settings: { key: string; value: unknown }[] = [
  {
    key: 'business_hours',
    value: { start: '08:00', end: '18:00', timezone: 'Africa/Lagos' },
  },
...
async function main() {
  ...
  const adminEmail = process.env.SEED_ADMIN_EMAIL ?? 'kellelectricals@gmail.com'
  const adminPassword = process.env.SEED_ADMIN_PASSWORD ?? 'ChangeMe-KellAdmin-2026'
