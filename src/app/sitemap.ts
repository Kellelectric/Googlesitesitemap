...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/leadership`, lastModified: new Date(), priority: 0.5, changeFrequency: 'monthly' },
    ...
    { url: `${base}/book-appointment`, lastModified: new Date(), priority: 0.7, changeFrequency: 'monthly' },
    ...
    { url: `${base}/legal/terms`, lastModified: new Date(), priority: 0.3, changeFrequency: 'yearly' },
    { url: `${base}/legal/privacy`, lastModified: new Date(), priority: 0.3, changeFrequency: 'yearly' },
  ]
