...
// industry page has no quick path to call, WhatsApp, or request a quote
// without scrolling back to the top. This keeps the three highest-intent
// actions one tap away at all times on small screens (hidden on lg+, where
// the header CTA is always visible).
export function MobileCallBar() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-paper/10 bg-petrol lg:hidden">
      <a
      ...
      <a
        ...
        onClick={() => trackEvent('contact', { channel: 'quote_form', placement: 'mobile_bar' })}
